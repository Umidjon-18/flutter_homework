                          ...
                          children: [
                            Row(
                              children: [
                                const Image(
                                  image: AssetImage(
                                      'assets/weather_icons/ic_location.png'),
                                  width: 15,
                                  height: 17.48,
                                ),
                                  ...
                                  child: DropdownButton(
                                    ...
                                    onChanged: (String? newValue) {
                                      setState(() {
                                        ...
                                        requestName = newValue.toLowerCase();
                                        data = null;
                                      });
                                    },
                                  ),
                                ...
                                children: [
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Image(
                                        image: _weatherIcon(data?.today?[3]
                                            .toString()
                                            .toLowerCase()),
                                        width: 160,
                                        height: 160,
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: RichText(
                                        text: TextSpan(
                                          text:
                                              '${data?.today?[0].toString().substring(0, 5)}\n',
                                          style: kTextStyle(
                                              size: 16,
                                          ...
                                          children: [
                                            TextSpan(
                                              text:
                                                  ' ${data?.today?[0].toString().substring(6)}',
                                              style: kTextStyle(
                                                  size: 16,
                                                  fontWeight: FontWeight.w500),
                                            ),
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      const Image(
                                        image: AssetImage(
                                            'assets/weather_icons/quality_air.png'),
                                        width: 29.17,
                                        height: 29.17,
                                      ),
                                    ...
                                    children: [
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          _itemInfo(
                                              'assets/weather_icons/ic_rain_perc.png',
                                              'Namlik',
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          const SizedBox(height: 20),
                                          _itemInfo(
                                              'assets/weather_icons/ic_moon.png',
                                              "Oy ko'rinishi",
